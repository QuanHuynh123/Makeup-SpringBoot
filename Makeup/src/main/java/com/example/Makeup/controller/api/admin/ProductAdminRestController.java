...
public class ProductAdminRestController {
    ...
    @GetMapping
    public ApiResponse<Page<ProductDTO>> getAllProducts(@RequestParam(value = "page", defaultValue = "0") Integer page,
    ...
    public ApiResponse<ProductDTO> updateProduct(UpdateProductRequest productDTO,
                                                 @PathVariable("id") UUID productId) throws IOException {
