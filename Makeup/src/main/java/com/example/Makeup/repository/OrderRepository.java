...
public interface OrderRepository extends JpaRepository<Order, UUID> {
  ...
  @Query(
      "SELECT MONTH(o.orderDate), COUNT(o) FROM Order o WHERE YEAR(o.orderDate) = :year GROUP BY MONTH(o.orderDate)")
  List<Object[]> findOrdersCountByMonth(@Param("year") int year);

  @Query(
      "SELECT DATE(o.orderDate), COUNT(o) FROM Order o WHERE o.orderDate BETWEEN :startDate AND :endDate GROUP BY DATE(o.orderDate)")
  List<Object[]> findOrdersCountByDateRange(
      @Param("startDate") Date startDate, @Param("endDate") Date endDate);

  @Query(
      "SELECT DAY(o.orderDate), COUNT(o) FROM Order o WHERE MONTH(o.orderDate) = :month AND YEAR(o.orderDate) = :year GROUP BY DAY(o.orderDate)")
  List<Object[]> findOrdersCountByCurrentMonth(@Param("month") int month, @Param("year") int year);

  @Query(
      "SELECT DATE(o.orderDate), COUNT(o) FROM Order o WHERE o.orderDate BETWEEN :startDate AND :endDate GROUP BY DATE(o.orderDate)")
  List<Object[]> findOrdersCountByCustomRange(
      @Param("startDate") Date startDate, @Param("endDate") Date endDate);

  List<Order> findByUserId(UUID userId);

  @Query(
      "SELECT new com.example.Makeup.dto.response.OrdersAdminResponse("
  ...
  @Modifying
  @Query(
      "DELETE FROM Order o WHERE o.status = 'PAYMENT_NOT_COMPLETED' AND o.createdAt < :expiredTime")
