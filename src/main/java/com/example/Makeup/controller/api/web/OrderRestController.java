...
public class OrderRestController {
  ...
  public ApiResponse<OrderDTO> getOrder(@PathVariable UUID orderId) {
    return ApiResponse.success("Get order successfully", orderService.getOrder(orderId));
  }
  ...
  public ApiResponse<List<OrderItemDetailResponse>> getOderItems(
    ...
    return ApiResponse.success("Get order items detail successfully", orderService.getItemsDetail(orderId));
  }
  ...
  public ApiResponse<String> updateStatusOrder(
    ...
    return ApiResponse.success("Update order status successfully", orderService.updateOrderStatus(orderId, status));
  }
  ...
  public ApiResponse<Boolean> checkRepaymentCondition(@PathVariable UUID orderId) {
    return ApiResponse.success("Check repayment condition successfully", orderService.checkRepaymentCondition(orderId));
  }
}
